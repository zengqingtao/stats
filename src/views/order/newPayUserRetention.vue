<template>
  <d2-container>
    <template slot="header">新付款用户留存</template>
    <div class="header">
      ...
      <div class="source-box">
        ...
        <el-button class="source-option" type="primary" @click="exportData">导出数据</el-button>
      </div>
    </div>
    <!-- 曲线图 -->
...
import { getBuyRetentionList } from "@/api/stats/getNewPayUserRetention";
export default {
  data() {
    this.chartSettings = {
      labelMap: {
