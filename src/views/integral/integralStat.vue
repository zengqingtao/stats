<template>
  <!-- 积分任务统计页面 -->
  <d2-container>
    <template slot="header">积分统计</template>
    <!-- 顶部 -->
    <div class="header">
...
import { getIntegralStat } from "@/api/integral/getIntegralStat";
...
export default {
  ...
  data: function() {
    return {
      ...
      exportColumns: [
        { label: "日期", prop: "date" },
        { label: "签到领积分用户数", prop: "sign_user_num" },
        { label: "成功下单领积分用户数", prop: "order_user_num" },
        { label: "分享任意商品领积分用户数", prop: "share_user_num" },
        { label: "帮好友砍价领积分用户数", prop: "help_user_num" }
      ]
    };
  },
  created() {
