<template>
  <d2-container>
    <template slot="header">综合购买留存</template>
    <div class="header">
    ...
    <div class="statisticalChart">
      <ve-line v-if="!isNull" class="ve-line" :loading="loading" :data="chartData" :settings="chartSettings"></ve-line>
...
import { getSynthesisBuyList } from "@/api/stats/getSynthesisBuyList";
export default {
  data() {
    this.chartSettings = {
      labelMap: {
    ...
    return {
      ...
      crudColumns: [
        { title: "日期", key: "date" },
        { title: "订单数量 ", key: "order_num" },
        { title: "活跃用户", key: "active_num" },
        { title: "付款用户", key: "uv_num" },
        { title: "客单价", key: "arpu_num" },
        { title: "累积付款用户", key: "accumulative_user" },
        { title: "新付款用户", key: "user_num" },
  ...
  methods: {
    ...
    synthesisBuyList() {
      ...
      getSynthesisBuyList({
        ...
        this.chartData.rows[0].user_num = rowsdata.that_very_day;
        this.chartData.rows[1].user_num = rowsdata.after_one_day;
        this.chartData.rows[2].user_num = rowsdata.after_two_day;
        this.chartData.rows[3].user_num = rowsdata.after_three_day;
        this.chartData.rows[4].user_num = rowsdata.after_four_day;
        this.chartData.rows[5].user_num = rowsdata.after_five_day;
        this.chartData.rows[6].user_num = rowsdata.after_six_day;
        this.chartData.rows[7].user_num = rowsdata.seven_to_fourteen;
        this.chartData.rows[8].user_num = rowsdata.fifteen_to_thirty;
