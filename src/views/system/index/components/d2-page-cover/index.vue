  ...
  <div class="d2-container" >
    ...
    <div class="order-money-box">
      <div class="order-money-item">
        <ve-line  class="ve-line" :data="chartData1" :settings="chartSettings1" :series="time_status=='today'?series1:series11" :legend="time_status=='today'?legend1:legend2" :colors="time_status=='today'?colors1:colors2"></ve-line>
        <div class="ve-line-subtitle">新用户</div>
      </div>
      <div class="order-money-item">
        <ve-line  class="ve-line" :data="chartData4" :settings="chartSettings4" :series="time_status=='today'?series2:series21" :legend="time_status=='today'?legend1:legend2" :colors="time_status=='today'?colors1:colors2"></ve-line>
        <div class="ve-line-subtitle">活跃用户</div>
      </div>
    </div>
    <div class="order-money-box">
      <div class="order-money-item">
        <ve-line  class="ve-line" :data="chartData3" :settings="chartSettings3" :series="time_status=='today'?series3:series31" :legend="this.time_status=='today'?legend1:legend2" :colors="time_status=='today'?colors1:colors2"></ve-line>
        <div class="ve-line-subtitle">订单数</div>
      </div>
      <div class="order-money-item">
        <ve-line  class="ve-line" :data="chartData2" :settings="chartSettings2" :series="time_status=='today'?series4:series41" :legend="this.time_status=='today'?legend1:legend2" :colors="time_status=='today'?colors1:colors2"></ve-line>
